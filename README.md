...
* **Objective**: Work with MLPs and CNNs. Try to understand what strategy is better between adding more hidden layer or adding skip-connection.
* TODO - Add the comparison between MLPs and ResidualMLPs
* TODO - Add the comparison between CNNs and ResidualCNNs
